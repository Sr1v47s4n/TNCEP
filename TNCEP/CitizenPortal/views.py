...
def signup_usr(request):
    try:
        if request.method == "POST":
            ...
            citizen_aadhaar = request.POST["citizen_aadhaar"]
            citizen_caahaar = request.POST["citizen_caahaar"]
            ...
            if citizen_aadhaar == citizen_caahaar:
                if citizen_password == citizen_confirm_password:
                    citizen = Citizen(citizen_fname=citizen_fname, citizen_email=citizen_email, citizen_phno=citizen_phno, citizen_city=citizen_city, citizen_locality=citizen_locality, citizen_dob=citizen_dob, citizen_address=citizen_address, citizen_pincode=citizen_pincode, password=citizen_password)
                    citizen.save()
                    return redirect("login")
                else:
                    return redirect("signup")
            else:
                return render(request, "signup.html",{"error": "Aadhaar Number does not match!"})
